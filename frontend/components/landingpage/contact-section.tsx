    ...
    return (
        ...
        >
            ...
            <div className="container max-w-5xl">
                <ScrollAnimatedSection direction="up" className="mb-8 text-center lg:mb-12">
                ...
                <div className="grid items-start gap-8 lg:grid-cols-2 lg:gap-12">
                    <ScrollAnimatedSection direction="right" delay={100}>
                    ...
                    <ScrollAnimatedSection direction="left" delay={200}>
                        <form
